...
PAGES = [
 {
  ...
  'days': [
   {'name':'ערב ראש השנה','day':'שישי','date':'כ״ט אלול · 11.9.26',
    ...
    'rows':[('סליחות','04:50','06:00'),('שחרית · הודו','06:00','07:00'),
   ...
   {'name':'צום גדליה','day':'שני','date':'ג׳ תשרי · 14.9.26',
    ...
    'rows':[('סליחות','04:50','05:45'),('שחרית · הודו','06:00','07:00'),
            ('מנחה · חצי שעה קודם השקיעה','','18:21'),
            ('ערבית · לדוד בשקיעה','','18:51')]},
   ...
   {'name':'שבת שובה','day':'שבת קודש','date':'ז׳–ח׳ תשרי · 18–19.9.26','hl':True,
    'sky':'זריחה 06:25 · שקיעה 18:44 · צאת הכוכבים 18:59 · צאת השבת 19:15',
    'rows':[('מנחה וקבלת שבת','','18:24'),('שחרית · קרבנות','05:25','07:30'),
            ('מנחה גדולה ושיעור','','13:15'),('שיעור','','16:30'),
            ('מנחה וסעודה שלישית','','17:30'),('ערבית · 10 דק׳ קודם צאת השבת','','19:05')]},
  ...
  ]},
 {
  ...
  'days': [
   {'name':'סוכות','day':'שבת קודש','date':'ט״ו בתשרי · 26.9.26','hl':True,
    'sky':'זריחה 06:30 · שקיעה 18:35 · צאת הכוכבים 18:49 · צאת השבת 19:06',
    'rows':[('מנחה, קבלת שבת וערבית','','18:10'),('שחרית','05:30','07:30'),
            ('מנחה ושיעור','','13:15'),('שיעור','','16:30'),
            ('מנחה וסעודה שלישית','','17:30'),('ערבית · 10 דק׳ קודם צאת השבת','','18:56')]},
   ...
   {'name':'שמחת תורה','day':'שבת קודש','date':'כ״ב בתשרי · 3.10.26','hl':True,
    'sky':'זריחה 06:34 · שקיעה 18:26 · צאת הכוכבים 18:40 · צאת החג 18:57',
    'rows':[('מנחה, קבלת שבת וערבית','','18:00'),('שחרית · קרבנות','05:35','07:00'),
            ('שיעור','','16:15'),('מנחה וסעודה שלישית','','17:15'),
            ('ערבית · 10 דק׳ קודם צאת החג','','18:47')]},
  ]},
]
...
CSS = """
  *{box-sizing:border-box}
  ...
  .toolbar .status{color:#cfc6b4;font-size:13px;margin-inline-start:auto;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;min-width:0}
